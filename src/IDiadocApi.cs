...
namespace Diadoc.Api
{
	public interface IDiadocApi
	{
		...
		MessagePatch PostMessagePatchV2(string authToken, MessagePatchToPostV2 patch, string operationId = null);
 ...
 null, string id = null, bool autoConfirm = true);
		...
		Task<MessagePatch> PostMessagePatchAsyncV2(string authToken, MessagePatchToPostV2 patch, string operationId = null);
